...
- getting started?? how do you adapt your code for new deliverables?
- sorting logic!
...
- Allow the user to _filter_ the hogs that are **greased**
  show all the hogs, or only show the greasy ones
  show the greased ones, or the not greased ones
...
- list of hogs (props)
- whether or not a hog is showing its details (state)
- some checked or not checked value for showing the greased hogs (state)
- how the hogs are sorted (name/weight) (state)
- which hogs are being displayed (not state)
