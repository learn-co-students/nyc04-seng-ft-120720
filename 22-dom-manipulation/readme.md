...
- [ ] Update the first card's picture
- [ ] Change the color of the news company to black
...
- [ ] add one new article card
  - innerHTML
  - artisanal way
- [ ] Create a card for each object in the `articles` array 
