...
"abc123" -> "gijeigjieljgilejligj.rekgjliejhilejg.wrgijewigjeigj"
"def123!@#$" -> "wirgliwjighljiehjej/wgjhgkjerlihgjreghe/gwsigjlisjfs"

"giowjeligjetljirjijhiej.fe,gl;emlkmekmhklemhflawglw/fgwjglwkwlgk" 

- What are rainbow tables and how can they defeat a password hashing strategy?
"abc123" -> "gijeigjieljgilejligj.rekgjliejhilejg.wrgijewigjeigj"
"def123!@#$" -> "wirgliwjighljiehjej/wgjhgkjerlihgjreghe/gwsigjlisjfs"
"ghi456" -> "gliehjilhjeoijhilejlh.faijfiusjghiejxh.lgkwjgofijlif"
"xyz123" -> "giowjeligjetljirjijhiej.fe,gl;emlkmekmhklemhflawglw/fgwjglwkwlgk" 

- What is salting? What is a salt? How can it defeat a rainbow tables attack?
"abc123" + "eric" -> "gjeiohjierhjlijfkb;.g;lk,go;dkg;d"
"abc123" + "tashawn" -> "gwlihjbelholknolekh.fjlsjglskjgkdafa"


### Implemention
0. Uncomment `bcrypt` gem
1. Figure out which model you want to save passwords to:
    In that model, create a column called `password_digest` (str)
2. In the above model(s), write the `has_secure_password` macro

What `has_secure_password` does:
(The only place you should write `password_digest` is in the migrations)
1. Will hash the password you save to the database (`password=`)
2. Gives you instance methods, one of them being `authenticate`
